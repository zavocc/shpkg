...
| `shpkg_distro_only`            | debian, archlinux, redhat, alpine, android   | No                | Tell if to install package for specific distro only (Alternatively, a user can specify case statements with `SHPKG_DISTRO` variable)         |
